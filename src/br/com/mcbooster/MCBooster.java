...
import br.com.mcbooster.listeners.ActiveBoosterListener;
...
public class MCBooster extends JavaPlugin{
	...
	public void onEnable() {
		...
		new ActiveBoosterListener(this);
	...
	private void start(){
			...
			public void run() {
				if(!playerBoosterManager.boosters.isEmpty()){
					for(PlayerBooster pb : playerBoosterManager.boosters.values()){
						if(System.currentTimeMillis() >= pb.getActivedTime()){
		...
		}.runTaskTimerAsynchronously(this, 20L, 10 * 20L);
	}
